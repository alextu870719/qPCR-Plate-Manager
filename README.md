...
- Quick sample input buttons (CLas+, CLas-, Water)
- Supports SYBR and TaqMan duplex modes
- Import/export CSV files for easy integration
- Plate naming for custom export filenames
- Credit: Developed for Chi-Kuan Tu
...
---
For questions or improvements, please contact Chi-Kuan Tu or open an issue on GitHub.
